...
public class Image_Profile_Fragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getUserProfile().getValue().getMyPosts().observe(getViewLifecycleOwner(), posts -> {
            Log.e("vp2", vp2.toString());
            if(posts != null){
                Log.e("posts", "!=null");
                adapter = new ImagePage2Adapter(this.getContext(), posts);
